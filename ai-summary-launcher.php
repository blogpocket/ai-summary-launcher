 ...
 * Description:       Muestra botones de texto (ChatGPT, Claude, Gemini, Grok, Perplexity) para abrir su interfaz con un prompt que resume el artículo. Copia el prompt al portapapeles antes de abrir la IA. Oculta en posts con la etiqueta "Microblog".
 * Version:           1.0.5
...
function aisl_default_options() {
    ...
    return array(
        ...
        'prompt_template'  => __( 'Por favor, analiza y resume este artículo en español, bien estructurado, destacando las ideas clave y los puntos principales. El público al que debe ir dirigido es principiante y no técnico. La fuente es {url}', 'ai-summary-launcher' ),
        'add_styles'       => 1,
...
function aisl_render_buttons( $post_id = null ) {
    ...
    $services = array(
        'chatgpt'    => array( 'label' => 'ChatGPT',     'url' => 'https://chatgpt.com/',             'prefill_supported' => false ),
        'claude'     => array( 'label' => 'Claude',      'url' => 'https://claude.ai/new?q=',         'prefill_supported' => true ),
        'gemini'     => array( 'label' => 'Gemini',      'url' => 'https://gemini.google.com/app',    'prefill_supported' => false ),
        'grok'       => array( 'label' => 'Grok',        'url' => 'https://grok.com/?q=',             'prefill_supported' => true ),
        'perplexity' => array( 'label' => 'Perplexity',  'url' => 'https://www.perplexity.ai/?q=',    'prefill_supported' => true ),
    );
    ...
    foreach ( $enabled as $key => $service ) {
        ...
        $html .= sprintf(
            '<li class="aisl-item"><a class="aisl-btn" data-service="%1$s" href="%2$s" target="%4$s" rel="nofollow noopener noreferrer"><span class="aisl-label">%3$s</span></a></li>',
            esc_attr( $key ),
            esc_url( $url ),
            esc_html( $label ),
    ...
    $html .= '</ul>';
    $html .= '<p class="aisl-hint">' . esc_html__( 'Si no ves el prompt autocompletado o ves el de una ejecución anterior (o aparece la página de acceso), el texto ya está copiado. Solo pégalo.', 'ai-summary-launcher' ) . '</p>';
            ...
            <table class="form-table" role="presentation">
                <tr>
                    ...
                    <td>
                        ...
                        <?php endforeach; ?>
                        <p class="description"><?php echo esc_html__( 'Selecciona qué botones mostrarás al usuario.', 'ai-summary-launcher' ); ?></p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <?php echo esc_html__( 'Añadir CSS básico para los botones', 'ai-summary-launcher' ); ?>
                        </label>
                    </td>
                </tr>
                <tr>
